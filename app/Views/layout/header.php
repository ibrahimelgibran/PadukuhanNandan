    ...
    <div class="container d-flex align-items-center">
      ...
      <nav id="navbar" class="navbar order-last order-lg-0">
        <ul>
          ...
          <!-- <li><a class="nav-link scrollto " href="http://localhost/dukuh/berita/read/what-is-padukuhan-nandan">TENTANG</a></li> -->
          <!-- <li class="dropdown"><a href="#"><span>TENTANG</span> <i class="bi bi-chevron-down"></i></a>
           ...
           -->
          <li><a class="nav-link scrollto" href="<?php echo base_url('berita') ?>">Artikel</a></li>
            <!-- <ul>
      ...
      <a href="<?php echo base_url('login') ?>" class="appointment-btn scrollto">
        Login <span class="d-none d-md-inline">Admin & Pengurus</span>
      </a>

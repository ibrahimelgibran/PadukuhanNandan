  ...
  <div class="card">
    <div class="card-body login-card-body" style="border-radius: 10px;">
      ...
      <div class="alert alert-warning text-center">
        ...
        <hr>
        <p>Halaman ini hanya tersedia untuk versi Premium. <br>Silakan Hubungi IEGCODE SUPPORT <a href="https://profil.iegcode.com/Contact">https://profil.iegcode.com/Contact</a></p>
      </div>
      <hr>
